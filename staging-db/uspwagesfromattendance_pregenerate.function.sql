...
1.12	21-Nov-2025		As per verbal discussion with Yatin Sir 		Shiv Kumar
						(No Written requirement available)
						If Hourly setup and Holiday then One Day salary Added
...
/**********************change 1.35 ends***************************************************/	
	...
	--Raise Notice 'v_empsalaryregister.flexiblemonthdays=% v_paiddays=%',v_empsalaryregister.flexiblemonthdays,v_paiddays;
