CREATE OR REPLACE FUNCTION public.uspgetorderwisewages(p_mprmonth integer, p_mpryear integer, p_ordernumber character varying DEFAULT NULL::character varying, p_emp_code bigint DEFAULT NULL::bigint, p_batch_no character varying DEFAULT NULL::character varying, p_action character varying DEFAULT NULL::character varying, p_createdby bigint DEFAULT NULL::bigint, createdbyip character varying DEFAULT NULL::character varying, p_criteria character varying DEFAULT NULL::character varying, p_process_status character varying DEFAULT NULL::character varying, p_issalaryorliability character varying DEFAULT 'S'::character varying, p_tptype character varying DEFAULT 'TP'::character varying, p_companycode character varying DEFAULT 'A0001'::character varying, p_payment_recordid bigint DEFAULT (- (9999)::bigint), p_paymentadvice record DEFAULT NULL::record, p_multipayoutrequestid bigint DEFAULT (0)::bigint)
 RETURNS refcursor
 LANGUAGE plpgsql
