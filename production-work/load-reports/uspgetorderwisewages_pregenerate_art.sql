CREATE OR REPLACE FUNCTION public.uspgetorderwisewages_pregenerate(p_mprmonth integer, p_mpryear integer, p_ordernumber character varying DEFAULT NULL::character varying, p_emp_code bigint DEFAULT NULL::bigint, p_batch_no character varying DEFAULT NULL::character varying, p_action character varying DEFAULT NULL::character varying, p_createdby bigint DEFAULT NULL::bigint, createdbyip character varying DEFAULT NULL::character varying, p_criteria character varying DEFAULT NULL::character varying, p_process_status character varying DEFAULT NULL::character varying, p_issalaryorliability character varying DEFAULT 'S'::character varying, p_tptype character varying DEFAULT 'TP'::character varying, p_advice_attendancerecord text DEFAULT ''::text, p_advance_or_current text DEFAULT 'Current'::text, p_multipayoutrequestid bigint DEFAULT 0, p_fullmonthincentive numeric DEFAULT 0.0000)
 RETURNS refcursor
 LANGUAGE plpgsql
AS $function$
