...
4.0		09-march-2026	upper bound of FOR loop cannot be null				antigraviy-vinod
4.1		01-May-2026		Fractional carry-over rounding fix for AC_1, AC_10, AC_2, AC21	antigravity-vinod
*************************************************************************************************************/
/********************Part 1.9 starts*******************************/	
...
if trim(v_payout_mode_type) in ('standard','dfm','eor') then
select sum(ceil(coalesce(employeeesirate,0))+coalesce(employeresirate,0)) 
	  +sum(round(coalesce(epf,0)::numeric)+round(coalesce(vpf,0)::numeric)+floor(coalesce(ac_1,0)::numeric)+round(coalesce(ac_10,0)::numeric+(coalesce(ac_1,0)::numeric-floor(coalesce(ac_1,0)::numeric)))+floor(coalesce(ac_2,0)::numeric)+round(coalesce(ac21,0)::numeric+(coalesce(ac_2,0)::numeric-floor(coalesce(ac_2,0)::numeric)))) 
...
create temporary table pregeneratedpay(ecode bigint,salary numeric(18,2),pausedsalary numeric(18,2),paiddays numeric(18,2),salmon int,salyear int,unpaidac21 numeric,unpaidepf numeric,netpay numeric(18,2),pausednetpay numeric(18,2));
...
/******************************************************************/
insert into pregeneratedpay select pa.emp_code,(case when v_payout_mode_type='hybrid' then 0 else coalesce(pa.netpay,0) end+coalesce(insurance::numeric(18,2),0)+coalesce(employerinsuranceamount,0)+coalesce(ceil(pa.employeeesirate::numeric),0)+coalesce(pa.employeresirate::numeric)+round(coalesce(pa.epf,0)::numeric)+coalesce(pa.vpf,0)+floor(coalesce(pa.ac_1,0)::numeric)+round(coalesce(pa.ac_10,0)::numeric+(coalesce(pa.ac_1,0)::numeric-floor(coalesce(pa.ac_1,0)::numeric)))+floor(coalesce(pa.ac_2,0)::numeric)+round(coalesce(pa.ac21,0)::numeric+(coalesce(pa.ac_2,0)::numeric-floor(coalesce(pa.ac_2,0)::numeric)))+coalesce(pa.professionaltax,0)+case when v_tbl_account.payout_mode_type in('standard','self','dfm','eor') then coalesce(pa.lwf_employer,0)+coalesce(pa.lwf_employee,0)+coalesce(pa.tds,0) else 0 end+case when v_workreportexists='N' then 0 else ((coalesce(v_bonus,0))*(case when coalesce(ceil(pa.employeeesirate::numeric),0)>0 then .04 else 0 end)) end)+coalesce(pa.mealvoucher,0),0,pa.paiddays,pa.mprmonth,pa.mpryear,round(coalesce(pa.ac21,0)::numeric+(coalesce(pa.ac_2,0)::numeric-floor(coalesce(pa.ac_2,0)::numeric))),round(coalesce(pa.epf,0)::numeric),coalesce(pa.netpay,0),0
...
select sum(case when v_payout_mode_type='hybrid' then 0 else coalesce(pa.netpay,0) end+coalesce(insurance::numeric(18,2),0)+coalesce(employerinsuranceamount,0)+coalesce(ceil(pa.employeeesirate::numeric),0)+coalesce(pa.employeresirate::numeric)+round(coalesce(pa.epf,0)::numeric)+coalesce(pa.vpf,0)+floor(coalesce(pa.ac_1,0)::numeric)+round(coalesce(pa.ac_10,0)::numeric+(coalesce(pa.ac_1,0)::numeric-floor(coalesce(pa.ac_1,0)::numeric)))+floor(coalesce(pa.ac_2,0)::numeric)+round(coalesce(pa.ac21,0)::numeric+(coalesce(pa.ac_2,0)::numeric-floor(coalesce(pa.ac_2,0)::numeric)))+coalesce(pa.professionaltax,0)+case when v_tbl_account.payout_mode_type in ('standard','dfm','eor') then coalesce(pa.lwf_employer,0)+coalesce(pa.lwf_employee,0)+coalesce(pa.tds,0) else 0 end+case when v_workreportexists='N' then 0 else ((coalesce(v_bonus,0))*(case when coalesce(ceil(pa.employeeesirate::numeric),0)>0 then .04 else 0 end)) end)
		...
		from (
			 ...
			 left join (
				 	select op.customeraccountid,
						sum(case when coalesce(ts.issalarydownloaded,'')='P' then coalesce(netpay,0) +case when (coalesce(tmpchallans.esichallanamount,0)<=0 or ts.esichallannumber is not null) then ceil(coalesce(employeeesirate,0))+coalesce(employeresirate,0) else 0 end+case when (coalesce(tmpchallans.pfchallanamount,0)<=0 or ts.pfchallannumber is not null) then  round(coalesce(epf,0)::numeric)+round(coalesce(vpf,0)::numeric)+floor(coalesce(ac_1,0)::numeric)+round(coalesce(ac_10,0)::numeric+(coalesce(ac_1,0)::numeric-floor(coalesce(ac_1,0)::numeric)))+floor(coalesce(ac_2,0)::numeric)+round(coalesce(ac21,0)::numeric+(coalesce(ac_2,0)::numeric-floor(coalesce(ac_2,0)::numeric)))+coalesce(professionaltax,0) else 0 end+case when v_tbl_account.payout_mode_type in ('standard','dfm','eor') then case when make_date(ts.mpryear,ts.mprmonth,1)>='2024-03-01'::date then coalesce(lwf_employer,0)+coalesce(lwf_employee,0) else 0 end+coalesce(tds,0) else 0 end
							when v_payout_mode_type in ('standard','dfm','eor') and ts.attendancemode='Ledger' and issalaryorliability='L' then 0
							when v_payout_mode_type in ('standard','dfm','eor') and op.appointment_status_id=15 then 0 
							when v_payout_mode_type in ('standard','dfm','eor') and coalesce(ts.issalarydownloaded,'')<>'P' then 0 
							case when v_payout_mode_type='hybrid' then 0 else coalesce(netpay,0) end+case when (coalesce(tmpchallans.esichallanamount,0)<=0 or ts.esichallannumber is not null) then ceil(coalesce(employeeesirate,0))+coalesce(employeresirate,0) else 0 end+case when (coalesce(tmpchallans.pfchallanamount,0)<=0 or ts.pfchallannumber is not null) then round(coalesce(epf,0)::numeric)+round(coalesce(vpf,0)::numeric)+floor(coalesce(ac_1,0)::numeric)+round(coalesce(ac_10,0)::numeric+(coalesce(ac_1,0)::numeric-floor(coalesce(ac_1,0)::numeric)))+floor(coalesce(ac_2,0)::numeric)+round(coalesce(ac21,0)::numeric+(coalesce(ac_2,0)::numeric-floor(coalesce(ac_2,0)::numeric))) else 0 end+case when v_tbl_account.payout_mode_type in ('standard','dfm','eor') then case when make_date(ts.mpryear,ts.mprmonth,1)>='2024-03-01'::date then coalesce(lwf_employer,0)+coalesce(lwf_employee,0) else 0 end+coalesce(professionaltax,0)+coalesce(tds,0) else 0 end end) netamountpaid
			 		from openappointments op inner join tbl_monthlysalary ts
				 		on op.emp_code=ts.emp_code
...
if trim(v_payout_mode_type) in ('standard','hybrid','dfm','eor') then	
	create temporary table tmpac21 as
				 	select op.customeraccountid,ts.mprmonth ac21month,ts.mpryear ac21year
				 			,sum(case when coalesce(ts.issalarydownloaded,'')='P' and (coalesce(tmpchallans.pfchallanamount,0)<=0 or ts.pfchallannumber is not null) then round(coalesce(ac21,0)::numeric+(coalesce(ac_2,0)::numeric-floor(coalesce(ac_2,0)::numeric)))
							when v_payout_mode_type in ('standard','dfm','eor') and coalesce(ts.issalarydownloaded,'')<>'P' then 0 
							else /*case when v_payout_mode_type='hybrid' then 0 else*/ case when (coalesce(tmpchallans.pfchallanamount,0)<=0 or ts.pfchallannumber is not null) then round(coalesce(ac21,0)::numeric+(coalesce(ac_2,0)::numeric-floor(coalesce(ac_2,0)::numeric))) else 0 end /*end*/ end) bareac21
...
if p_action='PayoutSummary' or p_action='PayoutDetails'  or p_action='VoucherDetails' then
	drop table if exists tmppayout;
			...
			as
				...
				,coalesce(sum(/*case when mts.EmpId is null then */(case when v_payout_mode_type='hybrid' then 0 else coalesce(tm.netpay,0) end+case when (coalesce(tmpchallans.esichallanamount,0)<=0 or tm.esichallannumber is not null) then coalesce(ceil(tm.employeeesirate),0)+coalesce(tm.employeresirate,0) else 0 end+case when (coalesce(tmpchallans.pfchallanamount,0)<=0 or tm.pfchallannumber is not null) then round(coalesce(tm.epf,0)::numeric)+coalesce(tm.vpf,0)+floor(coalesce(tm.ac_1,0)::numeric)+round(coalesce(tm.ac_10,0)::numeric+(coalesce(tm.ac_1,0)::numeric-floor(coalesce(tm.ac_1,0)::numeric)))+floor(coalesce(tm.ac_2,0)::numeric)+round(coalesce(tm.ac21,0)::numeric+(coalesce(tm.ac_2,0)::numeric-floor(coalesce(tm.ac_2,0)::numeric))) else 0 end+coalesce(tm.professionaltax,0)+case when v_tbl_account.payout_mode_type in ('standard','dfm','eor') then case when make_date(tm.mpryear,tm.mprmonth,1)>='2024-03-01'::date then coalesce(lwf_employer,0)+coalesce(lwf_employee,0) else 0 end+coalesce(tm.tds,0) else 0 end) /*else 0 end*/+coalesce(tm.mealvoucher,0)),0) totalpaid
				,coalesce(sum(case when coalesce(tm.issalarydownloaded,'')='P' or (v_payout_mode_type in ('standard','dfm','eor') and mts.EmpId is not null) or v_payout_mode_type='hybrid'  then 0 else (case when v_payout_mode_type='hybrid' then 0 else coalesce(tm.netpay,0) end+case when (coalesce(tmpchallans.esichallanamount,0)<=0 or tm.esichallannumber is not null) then coalesce(ceil(tm.employeeesirate),0)+coalesce(tm.employeresirate,0) else 0 end+case when (coalesce(tmpchallans.pfchallanamount,0)<=0 or tm.pfchallannumber is not null) then round(coalesce(tm.epf,0)::numeric)+coalesce(tm.vpf,0)+floor(coalesce(tm.ac_1,0)::numeric)+round(coalesce(tm.ac_10,0)::numeric+(coalesce(tm.ac_1,0)::numeric-floor(coalesce(tm.ac_1,0)::numeric)))+floor(coalesce(tm.ac_2,0)::numeric)+round(coalesce(tm.ac21,0)::numeric+(coalesce(tm.ac_2,0)::numeric-floor(coalesce(tm.ac_2,0)::numeric))) else 0 end+coalesce(tm.professionaltax,0)+case when v_tbl_account.payout_mode_type in ('standard','dfm','eor') then case when make_date(tm.mpryear,tm.mprmonth,1)>='2024-03-01'::date then coalesce(lwf_employer,0)+coalesce(lwf_employee,0) else 0 end+coalesce(tm.tds,0)+coalesce(tm.mealvoucher,0) else 0 end) end),0) totalundisbursed
				,coalesce(sum(case when coalesce(tm.issalarydownloaded,'')='P' or (v_payout_mode_type in ('standard','dfm','eor') and mts.EmpId is not null) or v_payout_mode_type='hybrid'  then 0 else case when (coalesce(tmpchallans.pfchallanamount,0)<=0 or tm.pfchallannumber is not null) then (round(coalesce(tm.ac21,0)::numeric+(coalesce(tm.ac_2,0)::numeric-floor(coalesce(tm.ac_2,0)::numeric)))) else 0 end end),0) totalundisbursed_ac21
				,coalesce(sum(case when coalesce(tm.issalarydownloaded,'')='P' or (v_payout_mode_type in ('standard','dfm','eor') and mts.EmpId is not null) or v_payout_mode_type='hybrid'  then 0 else case when (coalesce(tmpchallans.pfchallanamount,0)<=0 or tm.pfchallannumber is not null) then (round(coalesce(tm.epf,0)::numeric)) else 0 end end),0) totalundisbursed_epf
				,coalesce(sum(case when tm.attendancemode<>'Ledger' then (case when v_payout_mode_type='hybrid' then 0 else coalesce(tm.netpay,0) end+case when (coalesce(tmpchallans.esichallanamount,0)<=0 or tm.esichallannumber is not null) then coalesce(ceil(tm.employeeesirate),0)+coalesce(tm.employeresirate,0) else 0 end+case when (coalesce(tmpchallans.pfchallanamount,0)<=0 or tm.pfchallannumber is not null) then round(coalesce(tm.epf,0)::numeric)+coalesce(tm.vpf,0)+floor(coalesce(tm.ac_1,0)::numeric)+round(coalesce(tm.ac_10,0)::numeric+(coalesce(tm.ac_1,0)::numeric-floor(coalesce(tm.ac_1,0)::numeric)))+floor(coalesce(tm.ac_2,0)::numeric)+round(coalesce(tm.ac21,0)::numeric+(coalesce(tm.ac_2,0)::numeric-floor(coalesce(tm.ac_2,0)::numeric))) else 0 end+coalesce(tm.professionaltax,0)+case when v_tbl_account.payout_mode_type in ('standard','dfm','eor') then case when make_date(tm.mpryear,tm.mprmonth,1)>='2024-03-01'::date then coalesce(lwf_employer,0)+coalesce(tm.lwf_employee,0) else 0 end+coalesce(tm.tds,0)+coalesce(tm.mealvoucher,0) else 0 end) else 0 end),0) totalamtpaid
				...
				,ta.id as customerid
				,ta.payout_settings
				,coalesce(sum(case when mts.EmpId is not null then (case when v_payout_mode_type='hybrid' then 0 else coalesce(tm.netpay,0) end+coalesce(ceil(tm.employeeesirate),0)+coalesce(tm.employeresirate,0)+round(coalesce(tm.epf,0)::numeric)+coalesce(tm.vpf,0)+floor(coalesce(tm.ac_1,0)::numeric)+round(coalesce(tm.ac_10,0)::numeric+(coalesce(tm.ac_1,0)::numeric-floor(coalesce(tm.ac_1,0)::numeric)))+floor(coalesce(tm.ac_2,0)::numeric)+round(coalesce(tm.ac21,0)::numeric+(coalesce(tm.ac_2,0)::numeric-floor(coalesce(tm.ac_2,0)::numeric)))+coalesce(tm.professionaltax,0)+case when v_tbl_account.payout_mode_type in ('standard','dfm','eor') then case when make_date(tm.mpryear,tm.mprmonth,1)>='2024-03-01'::date then coalesce(lwf_employer,0)+coalesce(tm.lwf_employee,0) else 0 end+coalesce(tm.tds,0) else 0 end) else 0 end),0) totalhold
				,0 unpaidac21
				,0 unpaidepf
				,null::int days_left
...
if p_action='PayoutDetails'  then
	open v_rfc2 for
				...
				,case /***/when coalesce(sum(case when mts.EmpId is not null then 0 else pregeneratedpay.salary end),0)>0 then ''/***/ when (coalesce(sum(tm.mprpaidsal_status),0)>0 or sum(coalesce(mprpaiddays,0))>0) /*and coalesce(sum(pregeneratedpay.salary),0)::numeric=0*/ then 'Paid' else '' end as paystatus
				...
				left join tmpyearmaster t on 1=1
				left join (select ecode,sum(salary) salary,sum(pausedsalary) pausedsalary,sum(paiddays) paiddays, salmon, salyear,sum(unpaidac21) unpaidac21,sum(unpaidepf) unpaidac21,sum(netpay) netpay from pregeneratedpay group by ecode, salmon, salyear)pregeneratedpay on pregeneratedpay.ecode=oa.emp_code
				left join ManageTempPausedSalary mts on mts.EmpId=oa.emp_id 
				and mts.IsActive='1'
				and  coalesce(mts.PausedStatus,'Enable')='Enable'
				and mts.ProcessYear =t.attyear
				...
				(select tm.emp_code,tm.is_advice,
				 ...
				 sum(case when v_payout_mode_type='hybrid'  then 0 else case when v_payout_mode_type='hybrid' and coalesce(tm.issalarydownloaded,'')<>'P'then 0 else coalesce(tm.netpay,0)-coalesce(totalarear,0) end+coalesce(employerinsuranceamount,0)+coalesce(ceil(tm.employeeesirate),0)+coalesce(tm.employeresirate,0)+coalesce(tm.employee_esi_incentive,0)+coalesce(tm.employer_esi_incentive,0)+round(coalesce(tm.epf,0)::numeric)+coalesce(tm.vpf,0)+floor(coalesce(tm.ac_1,0)::numeric)+round(coalesce(tm.ac_10,0)::numeric+(coalesce(tm.ac_1,0)::numeric-floor(coalesce(tm.ac_1,0)::numeric)))+floor(coalesce(tm.ac_2,0)::numeric)+round(coalesce(tm.ac21,0)::numeric+(coalesce(tm.ac_2,0)::numeric-floor(coalesce(tm.ac_2,0)::numeric)))+coalesce(tm.professionaltax,0)+case when v_tbl_account.payout_mode_type in('standard','self','dfm','eor') then case when make_date(tm.mpryear,tm.mprmonth,1)>='2024-03-01'::date then +coalesce(tm.lwf_employee,0)+coalesce(lwf_employer,0) else 0 end+coalesce(tm.tds,0)+coalesce(tm.mealvoucher,0) else 0 end end) paidsal,
				 ...
				 sum(case when v_payout_mode_type='hybrid'  or coalesce(tm.issalarydownloaded,'')<>'P' then 0 else coalesce(tm.netpay,0)-coalesce(totalarear,0)+coalesce(employerinsuranceamount,0)+coalesce(ceil(tm.employeeesirate),0)+coalesce(tm.employeresirate,0)+coalesce(tm.employee_esi_incentive,0)+coalesce(tm.employer_esi_incentive,0)+round(coalesce(tm.epf,0)::numeric)+coalesce(tm.vpf,0)+floor(coalesce(tm.ac_1,0)::numeric)+round(coalesce(tm.ac_10,0)::numeric+(coalesce(tm.ac_1,0)::numeric-floor(coalesce(tm.ac_1,0)::numeric)))+floor(coalesce(tm.ac_2,0)::numeric)+round(coalesce(tm.ac21,0)::numeric+(coalesce(tm.ac_2,0)::numeric-floor(coalesce(tm.ac_2,0)::numeric)))+coalesce(tm.professionaltax,0)+case when v_tbl_account.payout_mode_type in ('standard','dfm','eor') then case when make_date(tm.mpryear,tm.mprmonth,1)>='2024-03-01'::date then +coalesce(tm.lwf_employee,0)+coalesce(lwf_employer,0) else 0 end+coalesce(tm.tds,0)+coalesce(tm.mealvoucher,0) else 0 end end) disbursedsal,
...
/*change 3.9*/	having (round(greatest(coalesce(sum(tm.paidsal),0)+coalesce(sum(case when mts.EmpId is not null then pausedsalary else pregeneratedpay.salary end),0),0)::numeric,0)>0 or max(pregeneratedpay.ecode) is not null or coalesce(sum(salpaidcount),0) >0)
