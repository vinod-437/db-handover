...
1.52	14-APR-2026		ta-days/Da-days for Jivo ACCOUNT	Vinod Kumar
************************************************************************/
select *
...
((coalesce(nullif(esiapplicablecomponents,0),coalesce(basic,0)+coalesce(hra,0)+coalesce(SpecialAllowance,0)+coalesce(Medical,0)+coalesce(commission,0)+coalesce(transport_allowance,0)+coalesce(overtime_allowance,0)+coalesce(children_education_allowance,0))+'||v_overtime||'+(coalesce(km_distance,0)*coalesce(perkilometerrate,0))+(coalesce(ta_days,0)*coalesce(travelallowance_rate,0))+(coalesce(days_per_month,0)*coalesce(dailyallowance_rate,0)))*0.03250)
